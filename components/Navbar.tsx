...
const navLinks = [
  { label: "About", href: "/about" },
  {
    label: "Locations",
    href: "/locations",
    dropdown: ["Melbourne", "Sydney", "Brisbane", "Perth"],
  },
  {
    label: "Services",
    href: "/services",
    dropdown: ["SEO", "Local SEO", "E-commerce SEO", "Link Building", "Content Marketing"],
  },
                ...
                <AnimatePresence>
                  {link.dropdown && openDropdown === link.label && (
                    <motion.div
                      ...
                      className="absolute top-full left-0 mt-1 w-48 bg-white rounded-xl shadow-lg border border-gray-100 py-1.5 overflow-hidden"
                    >
